...
@implementation RallyableUnitsInfo
...
- (void) update:(UnitContext *)context {
    ...
    // default to no units
    context.rallyableUnits = nil;
    context.closestRallyableUnit = nil;
    ...
    context.rallyableUnits       = rallyableUnits;
    context.closestRallyableUnit = closestRallyableUnit;
